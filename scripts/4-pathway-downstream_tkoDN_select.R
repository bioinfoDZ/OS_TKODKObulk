...
#make out dir
outdir <- 'results/comparative-de/TKO-vs-DKO/4.downstream/clusterprofiler/dn_select'
...
clustpercs[clustpercs$perc>=10,'relabel'] <- c('Cluster_1_Lipid_metabolism', 'Cluster_2_Angiogenesis', 'Cluster_7_Inflammation')
