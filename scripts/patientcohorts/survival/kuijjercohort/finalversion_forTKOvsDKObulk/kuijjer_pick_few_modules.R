...
# for kuijjer, only eventstatus....


#set outdir
outdir <- 'survivalanalysis/FINAL_TKO_VS_DKO/superfinal_kuijjer'
dir.create(outdir)
...
scores_to_test <- c('TKO_overexpressed', 'TKO_overexpressed_onlymyeloid', 'Monocytic_lineage', 'T_cells')
